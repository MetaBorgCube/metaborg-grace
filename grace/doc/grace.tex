...
\section{Parsing}
lalala some inlining: \code{var a := 3}

code useage:

%\inputgrace{grace}{../test/program/demo/class-foo.grace}
\lstinputlisting[language=Grace]{../test/program/demo/class-foo.grace}
...
\definecolor{darkblue}{rgb}{0.0,0.0,0.5} % darkblue


\lstset{
	language={Java},
	keywords={where, rules, native, operators, module, imports, signature, constructors, arrows},
	basicstyle=\small\ttfamily,%
	keywordstyle=\color{javapurple}\small\ttfamily\bfseries,%
	commentstyle={\color{javagreen}\small\ttfamily},%
...
%	identifierstyle=,
	...
	breaklines=false,
	escapeinside={},
	literate={./}{{{\color{blue}./}}}2 {.^}{{{\color{blue}.\^{}}}}2
		{(}{{{\color{darkblue}(}}}1
		{)}{{{\color{darkblue})}}}1
		{\{}{{{\color{darkblue}\{}}}1
		{\}}{{{\color{darkblue}\}}}}1
