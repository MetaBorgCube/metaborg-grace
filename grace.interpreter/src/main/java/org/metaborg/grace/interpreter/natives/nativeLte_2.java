...
public abstract class nativeLte_2 extends TermBuild {

      public nativeLte_2(SourceSection source) {
              super(source);
      }
      ...
      public boolean doOp(Object a, Object b) {
    	  if (a instanceof NumV_1_Term && b instanceof NumV_1_Term) {
    		  ...
    		  throw new RuntimeException("native_lte only works on integer numbers");
    	  }
      }

      public static TermBuild create(SourceSection source, TermBuild left, TermBuild right) {
              return nativeLte_2NodeGen.create(source, left, right);
      }
}